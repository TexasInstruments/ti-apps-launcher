...
Item {
    ...
    width: 120
    height: 300
    property real minimumValue: -10   // Min temperature
    property real maximumValue: 50    // Max temperature
    property real value: 20           // Current temperature
    property color fillColor: "green"   // Mercury color
...
//         anchors.horizontalCenter: tube.horizontalCenter
    ...
    // Major and Minor Tick Marks + Labels
    Repeater {
        ...
        delegate: Item {
            ...
            Row {
                ...
                Rectangle {
                    id: tick
                    width: isMajorTick ? 15 : 8  // Bigger ticks for major labels
                    height: 2
                    color: "black"
