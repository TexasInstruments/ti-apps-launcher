...
#if defined(SOC_J721E) || defined(SOC_AM62A) || defined(SOC_AM62) || defined (SOC_AM62_LP) || defined (SOC_AM62P)
...
void perfStatsDdrStatsReadCounters(uint32_t *val0, uint32_t *val1, uint32_t *val2, uint32_t *val3)
{
    ...
    if(is_first_time)
    {
        ...
        #if defined(SOC_AM62A) || defined(SOC_AM62) || defined (SOC_AM62_LP) || defined (SOC_AM62P)
