...
SOURCES += main.cpp backend/appsmenu.cpp backend/seva_store.cpp backend/settings.cpp backend/stats.cpp backend/benchmarks.cpp backend/camera_recorder.cpp backend/gpu_performance.cpp backend/live_camera.cpp utils/perf_stats.cpp 
